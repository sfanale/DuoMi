...
class Property(models.Model):
	...
	total_shares= models.DecimalField(default=10000,decimal_places=2,max_digits=12)
	rent_yield_per_share= models.DecimalField(decimal_places=2,max_digits=12)
	rent_yield=  models.DecimalField(decimal_places=2,max_digits=12) #this is the rent yield per share over share price *12
	@property
	def rent_yield_per_share(self):
		return self.rent_rate/self.total_shares
	@property
	def rent_yield(self):
		return (self.rent_yield_per_share/self.last_price)*1200
